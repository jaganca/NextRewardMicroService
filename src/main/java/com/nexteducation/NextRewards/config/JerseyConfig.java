...
public class JerseyConfig extends ResourceConfig {
	...
	private void configureSwagger() {
		...
		config.setTitle("NextRewards");
		config.setVersion("v1.0.0");
		config.setContact("Sarat Bhaswanth");
		config.setSchemes(new String[] { "http", "https" });
		config.setResourcePackage("com.nexteducation.NextRewards.module.controller");
	...
	public JerseyConfig() {
		...
		packages("com.nexteducation.NextRewards.module.controller");
		packages("com.nexteducation.NextRewards.module.model.response");
