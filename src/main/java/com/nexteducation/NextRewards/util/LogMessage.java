...
public final class LogMessage {
	...
	static public void warn(final String msg) {
		...
		try {
			...
			// System.out.println("Error while logging WARN");
			LogMessage.error(e.getMessage(), e);
		}
	}
	...
	static public void info(final String msg) {
		...
		try {
			...
			// System.out.println("Error while logging INFO");
			// e.printStackTrace();
			LogMessage.error(e.getMessage(), e);
		}
	}
	...
	static public void debug(final String msg) {
		...
		try {
			...
			// System.out.println("Error while logging DEBUG");
			// e.printStackTrace();
			LogMessage.error(e.getMessage(), e);
		}
	}
	...
	static public void log(final String msg) {
		...
		try {
			...
			/*
			 * else{ System.out.println("ERP -"+ msg); }
			 */
		} catch (final Exception e) {
	...
	static public void log(final String msg, final Exception exception) {
		...
		try {
			...
			if (LOGGER != null) {
				LOGGER.info("ERP -" + msg);
				LOGGER.error("ERP - EXCEPTION: ", exception);
			}
			/*
			 * else{ System.out.println("ERP -"+ msg); }
			 */
